---
title: Architecture
description: Technical architecture of the AgentHarness platform.
---

## Overview

AgentHarness is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
