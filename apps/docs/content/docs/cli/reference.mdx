---
title: CLI Reference
description: Complete command reference for the AgentHarness CLI and agent daemon.
---

The `multica` CLI connects your local machine to AgentHarness. It handles authentication, workspace management, issue tracking, and runs the agent daemon that executes AI tasks locally.
...
When connecting to a self-hosted AgentHarness instance, point the CLI to your server before logging in:
