...
description: Get started with AgentHarness Cloud — no setup required.
---

The fastest way to get started with AgentHarness — no setup required.

## 1. Sign up

Go to [openagent.run](https://openagent.run) and create an account.
...
```
Fetch https://github.com/EeroEternal/AgentHarness/blob/main/CLI_INSTALL.md and follow the instructions to install the AgentHarness CLI, log in, and start the daemon on this machine.
```
